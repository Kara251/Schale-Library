...
export const COLLECTIONS: Record<PanelCollectionKey, CollectionConfig> = {
  ...
  'online-events': {
    ...
    localized: true,
    populate: ['coverImage'],
    searchFields: ['title', 'organizer', 'country', 'region', 'tags', 'sourceName', 'sourceUrl'],
    defaultSort: 'startTime:desc',
    supportsDraft: true,
    fields: [
      'title', 'nature', 'eventFormat', 'statusOverride', 'country', 'region',
      ...
      'tags', 'sourceName', 'sourceUrl', 'lastVerifiedAt', 'description', 'publishedAt',
    ],
  },
  'offline-events': {
