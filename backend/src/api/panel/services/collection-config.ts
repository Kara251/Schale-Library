...
export const COLLECTIONS: Record<PanelCollectionKey, CollectionConfig> = {
  ...
  'online-events': {
    ...
    localized: true,
    populate: ['coverImage'],
    searchFields: ['title', 'organizer', 'region', 'platform', 'tags', 'sourceUrl'],
    defaultSort: 'startTime:desc',
    supportsDraft: true,
    fields: [
      'title', 'nature', 'eventFormat', 'statusOverride', 'region', 'platform',
      'startTime', 'endTime', 'link', 'ticketUrl', 'ticketStatus', 'ticketPriceText',
      'priceMin', 'priceMax', 'currency', 'coverImage', 'organizer', 'organizerVerified',
      'tags', 'sourcePlatform', 'sourceUrl', 'lastVerifiedAt', 'description', 'publishedAt',
    ],
  },
  'offline-events': {
    ...
    localized: true,
    populate: ['coverImage'],
    searchFields: ['title', 'organizer', 'country', 'region', 'city', 'venue', 'address', 'location', 'guests', 'tags', 'sourceUrl'],
    defaultSort: 'startTime:desc',
    supportsDraft: true,
    fields: [
      ...
      'currency', 'coverImage', 'organizer', 'organizerVerified', 'tags', 'sourcePlatform',
      'sourceUrl', 'lastVerifiedAt', 'description', 'publishedAt',
    ],
  },
  students: {
