...
Schale Library 是一个用于整理游戏作品《蔚蓝档案》相关内容，以及游戏外作品、活动与资料的系统。

图书馆 URL：[https://bakivo.com](https://bakivo.com)
...
- **开发辅助:** 本项目开发过程中使用了 Claude、ChatGPT、Gemini 等 AI 工具辅助设计、编码、审查与文档整理。
...
部署、数据库和后台维护账号恢复说明见 [部署说明](deployment.md)。

## 版权声明

- **代码版权:** 本项目仓库内的源代码遵循 [MIT License](../../LICENSE) 开源协议。
- **素材版权:** 本项目中使用的所有游戏原始或官方衍生素材，包括但不限于角色立绘、图标、语音、文本、UI 设计等，其知识产权均归属于 **Nexon Games**、**Yostar** 及相关版权方所有。本项目尊重 [《<蔚蓝档案>同人创作指引》](https://weibo.com/ttarticle/p/show?id=2309404965471018418185) 和 [『二次創作ガイドライン』](https://bluearchive.jp/fankit/guidelines)。
- **非盈利声明:** 本项目为粉丝自制的非盈利二创项目，旨在整理和展示游戏相关内容，不用于任何商业用途。如果版权方要求下架，本项目将无条件配合。
- **字体:** BlueakaBeta2GBK 来自 [基沃托斯古书馆](https://kivo.wiki)，Noto Sans JP 来自 [Google Fonts](https://fonts.google.com/noto/specimen/Noto+Sans+JP)。
