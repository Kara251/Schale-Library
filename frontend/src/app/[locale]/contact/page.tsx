...
const content: Record<Locale, {
    ...
    'zh-Hans': {
        ...
        socialTitle: '社交媒体',
        socialDesc: '以下为馆长的官方账号，其余同名账号与本站无关',
        bilibili: 'Bilibili',
        youtube: 'YouTube',
    },
    'en': {
        ...
        socialDesc: 'These are the official curator accounts. Other similarly named accounts are not affiliated with this site.',
        bilibili: 'Bilibili',
        youtube: 'YouTube',
    },
    'ja': {
        ...
        socialDesc: '以下は館長の公式アカウントです。同名の他アカウントとは無関係です。',
        bilibili: 'Bilibili',
        youtube: 'YouTube',
    },
}
