...
const labels: Record<Locale, {
  ...
  en: {
    ...
    description: 'Scan missing images, translations, duplicate sources, drafts, missing students, friend links, featured works, and invalid event times.',
    scan: 'Run scan',
  ...
  ja: {
    title: '品質チェック',
    description: '画像不足、翻訳不足、重複ソース、下書き、生徒未関連、相互リンク、おすすめ作品、イベント時間異常を確認します。',
    scan: '再スキャン',
    empty: '品質問題はありません。',
    issue: '問題',
    severity: '重要度',
