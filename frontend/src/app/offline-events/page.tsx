...
export const metadata = {
  title: "线下活动 - Schale Library",
  description: "浏览所有线下活动信息，支持搜索和筛选",
}

export default async function OfflineEventsPage() {
  const eventsRes = await getOfflineEvents(100).catch(() => ({ data: [] }))
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="relative flex-1 container mx-auto px-4 pt-6 pb-12">
        <EventsWithFilters events={events} type="offline" title="线下活动" />
      </main>
