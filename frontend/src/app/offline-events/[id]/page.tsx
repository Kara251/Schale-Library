...
export async function generateMetadata({ params }: PageProps) {
  ...
  const eventRes = await getOfflineEventById(Number(id)).catch(() => null)
  ...
  return {
    ...
    description: eventRes.data.description?.substring(0, 150) || '线下活动详情',
  }
}
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="relative flex-1 container mx-auto px-4 pt-6 pb-12">
        {/* 返回按钮 */}
        <Link href="/offline-events" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-6">
