...
export const translations = {
  'zh-Hans': {
    ...
    'research.spoiler.label': '阅读进度',
    'research.spoiler.warningTitle': '剧透警告',
    'research.spoiler.warningBody': '本条目涉及「{scope}」的剧情内容，超出你设置的阅读进度。',
    'research.spoiler.reveal': '仍要阅读',
    'research.spoiler.cardHint': '剧透：{scope}',
  ...
  'en': {
    ...
    'research.spoiler.label': 'Story progress',
    'research.spoiler.warningTitle': 'Spoiler warning',
    'research.spoiler.warningBody': 'This entry covers "{scope}", beyond your configured progress.',
    'research.spoiler.reveal': 'Read anyway',
    'research.spoiler.cardHint': 'Spoilers: {scope}',
  ...
  'ja': {
    ...
    'research.spoiler.label': 'ストーリー進行度',
    'research.spoiler.warningTitle': 'ネタバレ警告',
    'research.spoiler.warningBody': 'この記事は「{scope}」の内容を含み、設定した進行度を超えています。',
    'research.spoiler.reveal': 'それでも読む',
    'research.spoiler.cardHint': 'ネタバレ：{scope}',
